...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-users mr-2"></i> <span class="font-weight-semibold">Service</span></h4>
            <a href="#" class="header-elements-toggle text-body d-lg-none"><i class="icon-more"></i></a>
        </div>
        <div class="header-elements d-none">
            <div class="multi-select-toolbar" style="display: none">
                <button data-route="{{ route('service.index') }}" id="delete_selected_rows" class="btn btn-outline-danger mx-1">
            ...
            <Button id="refreshBtn" class="btn btn-outline-primary mx-1"> <i class="fas fa-redo mr-2"></i>
                Actualiser</Button>
            <a href="{{ route('service.create') }}" class="btn btn-outline-primary  mx-1"> <i class="icon-add mr-2">
                </i>
                Ajouter</a>
        </div>
    </div>
