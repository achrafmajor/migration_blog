            ...
            <div class="row">
                <div class="col-9">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('type',[1=>'Style 1 : with icon',0=>'Style 2 : with background'], null, ['class' => 'form-control SlectBox' , 'id' => 'type','required' => 'required']); !!}
                        <div class="form-control-feedback">
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('position', 'Position') !!}
                        {!! Form::select('position',[1=>'Right',0=>'Left'], null, ['class' => 'form-control SlectBox' , 'id' => 'position','required' => 'required']); !!}
                        <div class="form-control-feedback">
                        </div>
                    </div>
                    <div class="form-group">
